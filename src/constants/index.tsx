...
export const FEATURES = [
  {
    ...
    text: "ECHI is a unit of of ECWA Medical Department, charged with Evangelism through thr provision of compassionate, afforadable and high quality (primary and secondary) Health Services to the under privileged communities in Nigeria.",
    button: {
  ...
  },
  {
    ...
    text: "ECHI exist to glorify God through the provision of compassionate, affordable and qualitative health care services(primary and secondary) to the privileged communities in Nigeria",
    button: {
  ...
  },
  {
    ...
    // caption: "Secure & trustworthy",
    title: "VISION",
    text: "ECHI envisions to be a dynamic, self-sustaining healthcare initiave that evangelized through the provision of quality (primary and secondary) services to ensure heathy communities in Nigeria.",
    button: {
      icon: "/images/docs.svg",
      title: "Read the docs",
    },
  ...
  //   // caption: "Secure & trustworthy",
  //   title: "CORE VALUES",
  //   text: "Compassion - Honesty - Transparency - Christian Witness - Evangelism - Integrity - Sincerity - Quality - Contentment - Love",
  //   button: {
  //     icon: "/images/docs.svg",
  //     title: "Read the docs",
  //   },
...
export const ABOUTDETAILS = [
  {
    id: "0",
    icon: <IconMapPin size={50} stroke={1.5} />, // Represents "DISTRICTS"
    title: "DISTRICTS",
    numbers: 12,
  },
  {
    id: "1",
    icon: <IconBuilding size={50} stroke={1.5} />, // Represents "CLINICS"
    title: "CLINICS",
    numbers: 1340,
  },
  {
    id: "2",
    icon: <IconStethoscope size={50} stroke={1.5} />, // Represents "STAFF"
    title: "STAFF",
    numbers: 500,
  },
  {
    id: "3",
    icon: <IconUser size={50} stroke={1.5} />, // Represents "PATIENTS"
    title: "PATIENTS",
    numbers: 300000,
  },
];
...
export const faq = [
  ...
  {
    id: "4",
    question: "What are the vaccine preventable diseases?",
    answer:
  ...
  {
    id: "5",
    question: "My child is health, why do I need to vaccine him/her?",
    answer:
